...
(() => {
  ...
  function openModal(title, bodyHtml) {
    // v11: modal disabled to avoid stuck bottom-sheet popups on cached builds.
    alert(title || "");
  }
  ...
  // v12: route to dedicated pages (instead of missing modal functions)
  function openHistoryModal() {
    location.href = "./mypicks.html";
  }

  function openCompareModal(/*pickId*/ _id) {
